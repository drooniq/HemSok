        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OperationCost = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Residences_AspNetUsers_AgentId",
                        column: x => x.AgentId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Residences_Municipalities_MunicipalityId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "2e34d0ae-9519-4916-bddf-7db4b86ced7c", null, "Agent", "AGENT" },
                    { "4bbd7ae3-e90e-4ee6-8765-347969627940", null, "SuperAdmin", "SUPERADMIN" },
                    { "f12c3db7-6ba0-4b42-a37c-7d6e2547ac20", null, "Admin", "ADMIN" }
                });
