        ...
        public static List<Agency> Seed(HemSokDbContext dbContext)
        {
            if (!dbContext.Agencies.Any())
            {
                var agencies = new List<Agency>
                {
                    ...
                    new Agency
                    {
                        Name = "Happy Estate AB",
                        Description = "Kom köp mitt hus.",
                        Address = "Kohrsgatu 4, 795 70 Vikarbyn",
                        PhoneNumber = "070-0947832",
                        Email = "info@happyestate.se",
                        Website = "www.happyestate.se",
                        ImagePath = "https://cdn.dribbble.com/userupload/9803276/file/original-9d43993a729983cfeb6289b0fa1374ba.jpg"
                    }
                };
